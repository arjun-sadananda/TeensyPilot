...
int main(void)
{
    ...
    #elif serial_type == SERIAL_DEBUG
            static Vector3f euler;
            tp_estimator.q.to_euler(euler);
            // Serial.print(tp_estimator.GyroRate.x);
            // Serial.print(",");
            // Serial.print(tp_estimator.GyroRate.y);
            // Serial.print(",");
            // Serial.print(tp_estimator.GyroRate.z);
            // Serial.print(",");
            // Serial.print(tp_estimator.UnitAccVect.x);
            // Serial.print(",");
            // Serial.print(tp_estimator.UnitAccVect.y);
            // Serial.print(",");
            // Serial.print(tp_estimator.UnitAccVect.z);
            // Serial.print(",");
            // Serial.print(tp_estimator.UnitMagVect.x);
            // Serial.print(",");
            // Serial.print(tp_estimator.UnitMagVect.y);
            // Serial.print(",");
            // Serial.print(tp_estimator.UnitMagVect.z);
            // Serial.print(",");
