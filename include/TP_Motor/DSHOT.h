...
// FlexPWM2.0   4, 33
// FlexPWM1.3   7, 8, 25
// FlexPWM1.2	  24, 46, 47     24, 38, 39
// FlexPWM4.0	  22
// FlexPWM4.1	  23
// FlexPWM2.2	  6, 9

// // DMA eFlexPWM modules
#if DSHOT_MAX_OUTPUTS == 6
volatile IMXRT_FLEXPWM_t  *DSHOT_mods[DSHOT_NB_DMA_CHAN]  = 
                              { &IMXRT_FLEXPWM2, &IMXRT_FLEXPWM1, &IMXRT_FLEXPWM1, 
                                &IMXRT_FLEXPWM4, &IMXRT_FLEXPWM4, &IMXRT_FLEXPWM2 };

// DMA eFlexPWM submodules
volatile uint8_t          DSHOT_sm[DSHOT_NB_DMA_CHAN]     = { 0, 3, 2, 0, 1, 2 };

// DMA eFlexPWM submodule PWM channel selector: A=0, B=1, X=2
volatile uint8_t  	      DSHOT_abx[DSHOT_NB_DMA_CHAN]    = { 0, 0, 2, 0, 0, 1 };

// DMA source
volatile uint8_t          DSHOT_dmamux[DSHOT_NB_DMA_CHAN] = 
                    { DMAMUX_SOURCE_FLEXPWM2_WRITE0, DMAMUX_SOURCE_FLEXPWM1_WRITE3,
                      DMAMUX_SOURCE_FLEXPWM1_WRITE2, DMAMUX_SOURCE_FLEXPWM4_WRITE0,
                      DMAMUX_SOURCE_FLEXPWM4_WRITE1, DMAMUX_SOURCE_FLEXPWM2_WRITE2 };

// Output pins
volatile uint8_t          DSHOT_pin[DSHOT_NB_DMA_CHAN]    = { 4, 8, 24, 22, 23, 9 };

// Output pin ALT mux
volatile uint8_t          DSHOT_pinmux[DSHOT_NB_DMA_CHAN] = { 1, 6, 4, 1, 1, 2 };


#elif DSHOT_MAX_OUTPUTS == 4
volatile IMXRT_FLEXPWM_t  *DSHOT_mods[DSHOT_NB_DMA_CHAN]  = 
                              { &IMXRT_FLEXPWM2, &IMXRT_FLEXPWM1,   //&IMXRT_FLEXPWM1, 
                                &IMXRT_FLEXPWM4, &IMXRT_FLEXPWM4 }; //&IMXRT_FLEXPWM2 };
// volatile IMXRT_FLEXPWM_t  *DSHOT_mods[DSHOT_NB_DMA_CHAN]  = 
...
volatile uint8_t          DSHOT_sm[DSHOT_NB_DMA_CHAN]     = { 0, 3,   //2, 
                                                              0, 1 }; //2 };
// volatile uint8_t          DSHOT_sm[DSHOT_NB_DMA_CHAN]     = { 3, 0, 1, 2 };

volatile uint8_t  	      DSHOT_abx[DSHOT_NB_DMA_CHAN]    = { 0, 0,     // 2, 
                                                              0, 0 };   // 1 };
// volatile uint8_t  	      DSHOT_abx[DSHOT_NB_DMA_CHAN]    = { 0, 0, 0, 1 };

volatile uint8_t          DSHOT_dmamux[DSHOT_NB_DMA_CHAN] = 
                    { DMAMUX_SOURCE_FLEXPWM2_WRITE0, DMAMUX_SOURCE_FLEXPWM1_WRITE3,
                      DMAMUX_SOURCE_FLEXPWM4_WRITE0, DMAMUX_SOURCE_FLEXPWM4_WRITE1};
// volatile uint8_t          DSHOT_dmamux[DSHOT_NB_DMA_CHAN] = 
//                     { DMAMUX_SOURCE_FLEXPWM1_WRITE3,
//                       DMAMUX_SOURCE_FLEXPWM4_WRITE0,
//                       DMAMUX_SOURCE_FLEXPWM4_WRITE1, DMAMUX_SOURCE_FLEXPWM2_WRITE2 };

volatile uint8_t          DSHOT_pin[DSHOT_NB_DMA_CHAN]    = { 4, 8,     // 24, 
                                                              22, 23 }; // 9 };
// volatile uint8_t          DSHOT_pin[DSHOT_NB_DMA_CHAN]    = { 8, 22, 23, 9 };

volatile uint8_t          DSHOT_pinmux[DSHOT_NB_DMA_CHAN] = { 1, 6,     // 4, 
                                                              1, 1 };   // 2 };
// volatile uint8_t          DSHOT_pinmux[DSHOT_NB_DMA_CHAN] = { 6, 1, 1, 2 };
...
void (*DSHOT_DMA_ISR[4])()  = { DSHOT_DMA_interrupt_routine_0,
