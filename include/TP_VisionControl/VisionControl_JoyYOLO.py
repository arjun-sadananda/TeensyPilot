...
def controller(e_x, e_y):
    global e_x_prev, e_y_prev, prev_time, e_y_integral, dt
...
radio = pygame.joystick.Joystick(0)
radio.init()
...
with    serial.Serial(PORT, BAUD, timeout=2) as ser,\
    ...
    while True:
        ...
        cv2.putText(annotated_frame, str(round(dt*10**3, 2))+" ms", (200, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2) 
